...
<body>
	...
	<div class="container">
		...
		<form method="post" action="/lesson02/quiz05_1.jsp">
			<div class="d-flex align-items-end">     <!--<div class="d-flex >  -->
				<input type="text" name="length" class="form-control col-2">
				<span>cm</span>    <!--  <span class="ml-2 mt-3">cm</span> -->
			</div> 
			
			<div> 			<!-- 	<div class="mt-2"> -->
				<label class="mt-2">인치 <input type="checkbox" value="inch" name="type"></label>
			...
			<input type="submit" class="btn btn-success" value="변환하기">  	  <!-- 초록색 버턴 -->
		</form>
	</div>
